...
`docs/quality.md` benennt fuer 0.9.2 zwei offene Cluster im
DDL-Bereich:
...
- alle in `docs/quality.md` benannten Interpolationsstellen im
...
- die in `docs/quality.md` benannten Stellen in eine konkrete Matrix
  ueberfuehren:
  - Feld
  - Fundstelle
...
- sofern `docs/cli-spec.md` oder Generator-Regeln strukturierte
...
- `docs/implementation-plan-0.9.2.md`
- `docs/ImpPlan-0.9.2-6.4.md`

...
> `docs/roadmap.md` Milestone 0.8.0; `docs/design.md` Abschnitt 6.2,
> Abschnitt 6.3, Abschnitt 9.4; `docs/cli-spec.md` (`data export`,
> `data import`); `docs/guide.md`; `docs/implementation-plan-0.4.0.md`
...
- `docs/cli-spec.md`, `docs/design.md` und `docs/guide.md` angleichen
- klar festhalten:

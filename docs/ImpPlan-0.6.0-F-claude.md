...
Exit-Code-Mapping (konsistent mit docs/ImpPlan-0.6.0-F.md:278-301):
- 0: identisch
- 1: Unterschiede
...
**Datei editieren:** `docs/cli-spec.md`
...
| `docs/cli-spec.md` | Compare-Vertrag aktualisieren |

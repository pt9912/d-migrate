...
> Abschnitt 6 Phase C, Abschnitt 8, Abschnitt 9; `docs/planning/ImpPlan-0.8.0-A.md`;
> `docs/planning/ImpPlan-0.8.0-B.md`; `docs/planning/roadmap.md` Milestone 0.8.0;
> `spec/design.md` Abschnitt 9; `spec/cli-spec.md`;
...
- [x] Die Phase bleibt kompatibel mit `docs/planning/ImpPlan-0.8.0-A.md`,
      `docs/planning/ImpPlan-0.8.0-B.md` und dem 0.8.0-Masterplan.

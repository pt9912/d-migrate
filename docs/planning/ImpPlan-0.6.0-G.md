...
> **Referenz**: `docs/planning/implementation-plan-0.6.0.md` Abschnitt 4.5,
> Abschnitt 5 Phase G, Abschnitt 6.5, Abschnitt 7, Abschnitt 8,
> Abschnitt 9, Abschnitt 10; `docs/planning/ImpPlan-0.6.0-A.md`;
> `docs/planning/ImpPlan-0.6.0-B.md`; `docs/planning/ImpPlan-0.6.0-E.md`;
...
- `spec/cli-spec.md` beschreibt `data transfer` fuer 0.6.0 bereits als
...
- Nachfuehrung von `spec/cli-spec.md` auf den finalen Phase-G-Vertrag
...
- `spec/cli-spec.md` auf den finalen Phase-G-Flagvertrag nachziehen; der
...
- [ ] Routinen, Views und Triggerdefinitionen werden nicht implizit
      mitkopiert.
- [ ] `spec/cli-spec.md` beschreibt denselben Phase-G-Vertrag wie der Code.

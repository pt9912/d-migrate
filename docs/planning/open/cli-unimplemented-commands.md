...
| ------ | ----------- | ----------- | ------- |
| `transform procedure` | 6.3 | LF-017 | Phase 4 (KI-Integration) |
| `generate procedure` | 6.4 | LF-017 | Phase 4 (KI-Integration) |
| `data seed` | 6.2 | LF-024 | 1.3.0 (Testdaten) |
| `validate data` | 6.6 | LF-027 | — (siehe auch [`validate-data-against-schema.md`](../next/validate-data-against-schema.md)) |
| `validate procedure` | 6.6 | LN-034 | Phase 4 |
| `config credentials set` / `config credentials list` / `config show` | 6.7 | Credential-Management (`connection-config-spec.md` §4) | 1.0.0-RC (AES-256-Credentials, LN-025) |

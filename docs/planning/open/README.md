...
| [`pilot-rerun-p3-residuals.md`](pilot-rerun-p3-residuals.md) | Sammlung/Tracker | P3-Restbefunde des 0.9.9-Re-Runs: N7 (Custom-Aggregat von reverse nicht erfasst — Feature) + N8 (MySQL→PG Index-Namens-Kollision — generatorweiter State). Nicht RC-blockierend; P1/P2 (N1–N6) gefixt. |
...
| [`transfer-preflight-structural.md`](transfer-preflight-structural.md) | Vorabklaerung (Draft mit Scope) | Transfer-Preflight strukturell aus der Ziel-Dialekt-Typ-Abbildung ableiten (normalize(toSql(X))==normalize(toSql(Y))) statt Fall-fuer-Fall-Liste; beendet das Whack-a-Mole (Re-Run-2 M2, P1). Offene Design-Entscheidung: Port-Form application↔driver. |

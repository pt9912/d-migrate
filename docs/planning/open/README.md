...
| [`pilot-rerun-p3-residuals.md`](pilot-rerun-p3-residuals.md) | Sammlung/Tracker | P3-Restbefunde der 0.9.9-Re-Runs: N7 (Custom-Aggregat von reverse nicht erfasst — Feature), N8 (MySQL→PG Index-Namens-Kollision — generatorweiter State), K2 (`--include-all`-Routinen nicht topologisch geordnet). Nicht RC-blockierend; alle P1/P2 (I-01…10, N1–N6, M1/M2, K1) gefixt. |

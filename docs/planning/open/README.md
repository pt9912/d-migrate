...
| [`native-macos-build-marginal.md`](native-macos-build-marginal.md) | Befund mit Messreihe / Trigger Watch | Das `macos-latest`-Native-Leg erstickt im GC (Exit 30) trotz aktiver Drosselung (`MaxRAMPercentage=80`, `--parallelism=2`); zwei von drei scharfen Laeufen brauchten einen zweiten Versuch. Nicht toolchain-bedingt — der RC3-Tag fiel noch unter Kotlin 2.1.20. Drei Wege inkl. Streichung der Plattform. |

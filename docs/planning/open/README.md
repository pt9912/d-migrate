...
| [`sqlite-migrate-postcompare-identifier-drift.md`](sqlite-migrate-postcompare-identifier-drift.md) | Vorabklaerung | `migrate --execute` gegen SQLite meldet stets Post-Compare-Drift (Exit 5) wegen `identifier`→`primary_key`-Fingerprint-Asymmetrie; nicht-spatial, beim 5d-Live-Apply entdeckt. |

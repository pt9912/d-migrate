...
> **Status:** Teilweise umgesetzt (2026-09-13) — Leser steht, **sieben von
> acht** Schlüsseln sind verdrahtet, zwei weitere als Spec-Dopplung entfernt
> statt gebaut. Einer bleibt offen, als eigener [`next/`](../next/)-Plan.
...
> **Aktivierungsbedingung:** erfüllt für `postgresql.default_schema` — siehe
> den verlinkten `next/`-Plan.
...
7. **Die restlichen drei:**
   ...
   - ~~**`include_comments`**~~ — **erledigt 2026-09-13.** Bezeichnete nicht
     ...
     **kein** CLI-Flag (Ziel-Beschreibung wie `ddl.mysql.engine`, kein
     ...
     [`ddl-comment-rendering.md`](../done/ddl-comment-rendering.md).

...
> **Referenz**: `docs/planning/implementation-plan-0.6.0.md` Abschnitt 4.1 bis 4.4,
> Abschnitt 5 Phase E, Abschnitt 6.1, Abschnitt 6.3, Abschnitt 7,
> Abschnitt 8, Abschnitt 9, Abschnitt 10; `docs/planning/ImpPlan-0.6.0-B.md`;
> `docs/planning/ImpPlan-0.6.0-C.md`; `docs/planning/ImpPlan-0.6.0-D.md`;
...
- `spec/cli-spec.md` beschreibt `schema reverse` bereits als geplantes
...
- [ ] `spec/cli-spec.md` beschreibt denselben Reverse-Vertrag wie der Code.
...
`spec/cli-spec.md` dokumentiert aktuell fuer `schema reverse` noch einen

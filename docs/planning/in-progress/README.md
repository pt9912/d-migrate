...
| [`ImpPlan-0.9.8-parquet-S9a-bundle-tests.md`](ImpPlan-0.9.8-parquet-S9a-bundle-tests.md) | Skeleton | S9a Bundle-Test-Familien; startbereit nach S7/S8, sammelt Hand-off-Anker fuer CLI-Preflight-Codes, Format-Resolver, Bundle-Resume und DuckDB-/Arrow-Bundle-KV-Toleranz. |
| [`ImpPlan-0.9.8-parquet-S9b-single-file-tests.md`](ImpPlan-0.9.8-parquet-S9b-single-file-tests.md) | Skeleton | S9b Single-File-Test-Familien; startbereit nach S7/S8, sammelt Hand-off-Anker fuer CLI-Preflight-Codes, echte Parquet-Phase-1/2-Tests, Single-File-Resume und KV-Toleranz. |

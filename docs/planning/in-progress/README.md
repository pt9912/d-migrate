...
| [`oracle-dialect-scoping.md`](oracle-dialect-scoping.md) | Per-Feature-Umbrella | Oracle als fuenfter Dialekt (Milestone 1.8.0, [ADR 0052](../../adr/0052-oracle-fuenfter-dialekt-scoping.md)). Fuenf Grundsatzentscheidungen getroffen (Oracle 23ai Free/`gvenzl/oracle-free`, keine Carve-Outs, FUTC-JDBC-Lizenz-Compliance, CI in jedem Lauf, PL/SQL-Packages ohne Liefertermin); Slice 0 geliefert (Modul-Skeleton + Testcontainers-Spike live gruen), Slice 1 offen. |

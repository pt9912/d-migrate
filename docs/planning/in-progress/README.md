...
| [`reader-treue.md`](reader-treue.md) | Per-Feature-Umbrella (vier Plaene) | Stille Verluste und Fremdes im Reverse und am Generator. Traegt, was die vier Plaene teilen: gemeinsamer Nenner, Belegart, Verbleib jedes Postens, Regeln der Matrix-Abnahme (Neu-Pins einzeln, betroffene Zellen), Nulllinie der Integrationsmodule, Doku-Pflichten, Code-Tabelle (`R370`, `R371`, `R402`-`R405`, `R221`, `W162`-`W164`), entschiedene Eigner-Fragen (E1 = (b), E2, E3, Fingerabdruck-Anhebung). Reihenfolge 1 -> 2 -> 3 -> 4; die Plaene 1 und 2 sind geliefert und graduiert ([`../done/reader-treue-1-matrix-abnahme.md`](../done/reader-treue-1-matrix-abnahme.md), [`../done/reader-treue-2-meldungen.md`](../done/reader-treue-2-meldungen.md)), Plan 3 ist seit 2026-09-18 aktiv ([`reader-treue-3-spatial.md`](reader-treue-3-spatial.md)), Plan 4 steht in `../next/`. |
| [`reader-treue-3-spatial.md`](reader-treue-3-spatial.md) | Per-Slice-ImpPlan (Umbrella [`reader-treue.md`](reader-treue.md)) | Plan 3 des Reader-Umbrellas, Spatial-Treue: P4 PostgreSQL `geography` nur auf dem Rueckweg als Geometrie mit SRID (`R403`), samt Datenpfad und `geography`-Seed; P7 SpatiaLite `NOT NULL` nativ in Generate, Migrate (inkl. Rebuild) und Reverse; P2b/P2a PostGIS-Routinen und -Sichten und Oracles Spatial-Sequenzen stumm filtern, nach Katalog statt Namen; S5 (SQL Server `int IDENTITY` behaelt den Modus) und S6 (`smallint`-Identity wird mit `R406` gemeldet). |

...
| [`oracle-dialect-scoping.md`](oracle-dialect-scoping.md) | Per-Feature-Umbrella (Skeleton) | Oracle als fuenfter Dialekt (Milestone 1.8.0, [ADR 0052](../../adr/0052-oracle-fuenfter-dialekt-scoping.md)). Bestandsaufnahme + Oracle-Inventar + Slice-0-10-Schnitt stehen, alle vier Grundsatzentscheidungen getroffen (Oracle 23ai Free/`gvenzl/oracle-free`, keine Carve-Outs, FUTC-JDBC-Lizenz-Compliance, PL/SQL-Packages als offener Ausbau-Slice 11); Pending Slice-0-Baubeginn. |

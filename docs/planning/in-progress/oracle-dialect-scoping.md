...
| **4b** | Cross-Dialekt-sample-db-Smoke (Gegenrichtung Oracle → PG, analog `smoke-cross-ms2pg.sh`) — **nicht mehr blockiert**: der Harness-Anschluss und ein durchlaufender Transfer stehen seit 3b | Cross-Dialekt-Beleg in beide Richtungen |

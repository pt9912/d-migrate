...
| MCP-Migrate-Tool (`schema_migrate`/`_start`) | Promoted | Neues Produkt-/Contract-Thema. Vorabklärung 2026-06-03 angelegt; same-day Promote nach `next/` mit Sub-Slice-Schnitt F.1-F.6 + Wire-Vertrag V1. | [`../next/mcp-schema-migrate-tool.md`](../next/mcp-schema-migrate-tool.md), [`../open/atomic-preserve-service-mode.md`](../open/atomic-preserve-service-mode.md), quality-coverage-expansion-plan §3.2 + §9 |

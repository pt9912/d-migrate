...
| MCP-Migrate-Tool (`schema_migrate`/`_start`) | Promoted | Neues Produkt-/Contract-Thema. Service-Mode-Verträge sind Vorabklärung. | [`../next/atomic-preserve-service-mode.md`](../next/atomic-preserve-service-mode.md), quality-coverage-expansion-plan §3.2 + §9 |

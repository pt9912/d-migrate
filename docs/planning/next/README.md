...
| [`d-check-module-adoption.md`](d-check-module-adoption.md) | Next-Plan | Voll-Ausbau des Doku-Gates d-check (v0.9.0, 8 Module): matrix/hostpaths/spans sauber (0) → ins Gate; codepaths/ids kalibriert (suggest-config-Modell); echte Audit-Drift fixen; offene Entscheidungen D1–D3 (codepaths-Strategie, ids-Scope, done-Archiv). |

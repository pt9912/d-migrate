...
| [`mssql-dialect-scoping.md`](mssql-dialect-scoping.md) | Ausgearbeiteter Plan | MS SQL Server als vierter Dialekt (Milestone 1.7.0, vorgezogen). Drei Entscheidungen getroffen 2026-08-21: SQL Server 2017+, keine Carve-Outs (voller Funktionsumfang als Slices 0-10 inkl. Partitionierung/Volltext/Routinen/Profiling), MSSQL-Integrationsschiene in jedem CI-Lauf via generischem `-PintegrationTests`-Mechanismus. Aktiv (Move nach `../in-progress/`) beim ersten Slice-0-Commit. |

...
| [`persistence-jdbc-coverage-seam.md`](persistence-jdbc-coverage-seam.md) | Draft mit Scope | Entscheidung von Ausfuehrung trennen, damit die 421 nur integrations-gedeckten Produktivzeilen im Standard-Lauf echt geprueft werden. Weg 3 entschieden (2026-08-09); Muster „entscheiden, dann ausfuehren" am `reserve`-Pfad belegt; Sub-Slices S1-S5, je ein Kover-Exclude weniger. |

...
| [`ImpPlan-1.3.0-cli-data-seed-p1.md`](ImpPlan-1.3.0-cli-data-seed-p1.md) | ImpPlan (Draft) | Umsetzungsplan fuer Phase P1 (deterministischer Generator-Kern, kein `--rules`/`--ai-backend`) von [`cli-data-seed.md`](cli-data-seed.md): Datei-Liste, Architektur-Entscheidungen, Phasen AP1-AP6, pruefbare Akzeptanzkriterien. Wandert mit `cli-data-seed.md` nach `in-progress/`, sobald der erste Code-Commit landet. |

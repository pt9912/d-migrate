...
| [`sample-db-integration-harness.md`](sample-db-integration-harness.md) | Umsetzungsplan (Slice) | Automatisierter Sample-DB-Integrationstest-Harness (Pagila/Sakila/Employees) als reproduzierbare CI-Tests; Phase 1-2 Smoke/Compatibility = Test-Infra, Phase 3-4 Scale/Performance = 1.0.0-QA (LF 8.1/8.2). Pivotale Phase-0-Entscheidung: Dump-Sourcing (vendoren vs. download). |

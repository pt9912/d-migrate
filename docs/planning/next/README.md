...
| [`sample-db-harness-review-followups.md`](sample-db-harness-review-followups.md) | Next-Plan (Folge-Härtung) | Bash-Robustheit aus dem Phase-2/2b-Review: **F1** Paritäts-Schleifen-Generator-Schluck (False-Green, fixwürdig — alle 3 Smoke-Skripte), F2 Word-Splitting bei Leerzeichen-Pfad (latent), F3 tautologischer Decimal→REAL-Check (test-quality). Dual-variable False-Green durch pipefail widerlegt (kein Fix). |

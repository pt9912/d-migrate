...
| [`design-md-retire.md`](design-md-retire.md) | Next-Plan (Doku) | `spec/design.md` retiren — veralteter, redundanter Living-Ist/Soll-Overview, superseded by `architecture.md`. Einzigartiges §4 KI-Design folden, ~20 Live-Links umbiegen, `git mv` nach `docs/archive/` (+ scan.ignore). Aus Milestone-Hygiene-Slice ausgegliedert; maßgeblich ADR 0024. |

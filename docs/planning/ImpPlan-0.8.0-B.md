...
> Abschnitt 6 Phase B, Abschnitt 8, Abschnitt 9; `docs/planning/ImpPlan-0.8.0-A.md`;
> `docs/planning/roadmap.md` Milestone 0.8.0 und 0.9.0; `spec/design.md` Abschnitt 9;
> `spec/architecture.md` (`I18nConfig`); `spec/connection-config-spec.md`;
...
- [ ] `--lang` bleibt fuer Phase B ausserhalb des aktiven 0.8.0-
      Resolution-Vertrags.
- [ ] Der Teilplan bleibt kompatibel mit `docs/planning/ImpPlan-0.8.0-A.md` und dem
      0.8.0-Masterplan.

...
>
> Status: Draft
> Referenzen: `docs/planning/roadmap.md` Milestone 0.5.0, `spec/cli-spec.md` Abschnitt
> `schema compare` und `Fortschrittsanzeige`, `docs/user/releasing.md`,
...
- In `spec/cli-spec.md` sind `schema compare`, `schema migrate` und
...
`spec/cli-spec.md` werden auf spaeter verschoben.
...
- `docs/user/releasing.md` wird erweitert: `gh release create` oder
...
1. `spec/cli-spec.md` fuer `schema compare` auf den 0.5.0-MVP-Vertrag
   umstellen:
...
2. `spec/cli-spec.md` fuer `schema migrate` und `schema rollback`
   auf spaeteren Milestone verschieben
3. Abschnitt "Fortschrittsanzeige" auf den tatsaechlichen MVP-Umfang
   abgleichen
4. `docs/planning/roadmap.md` mit Verweis auf diesen Plan ergaenzen, sobald die
...
- `docs/user/guide.md` als Basis-Anwenderhandbuch
- `spec/cli-spec.md` als Referenz der implementierten Commands
- `docs/user/releasing.md` fuer Maintainer
...
- `docs/user/releasing.md` wird erweitert:
...
- `docs/user/releasing.md` beschreibt den manuellen Versions-/SHA-Bump
...
- `docs/planning/roadmap.md` und `spec/cli-spec.md` markieren 0.5.0 explizit als

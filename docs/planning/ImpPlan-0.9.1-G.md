...
> **Referenz**: `docs/planning/implementation-plan-0.9.1.md` Abschnitt 1 bis 5,
...
- wie `docs/user/releasing.md` und `docs/planning/roadmap.md` die Grenze zwischen
...
- `docs/user/releasing.md` beschreibt heute den Release-Ablauf fuer:
  - GitHub-Release-Assets
  - OCI-Image
  - Homebrew
- dass Maven Central noch **nicht** Teil dieses Vertrags ist, ist dort
  bereits explizit vermerkt
- `docs/planning/roadmap.md` fuehrt `0.9.1` bewusst als
...
- nach Phase C bis F kommen voraussichtlich hinzu:
  - `hexagon:ports-common`, `hexagon:ports-read`,
    `hexagon:ports-write` (Phase-C-Stretch-Goal; aus Phase D und dann aus Phase F
    ...
    Rahmen von Phase G -- das kann nicht verschoben werden)
...
- `docs/user/releasing.md` so schaerfen, dass der aktuelle Releaseprozess
  und der spaetere Library-Publish klar getrennt bleiben
- `docs/planning/roadmap.md` so schaerfen, dass `0.9.1` nicht als
...
### 5.4 `docs/user/releasing.md` auf zwei Ebenen schneiden

`docs/user/releasing.md` soll nach Phase G klar trennen zwischen:
...
### 5.5 `docs/planning/roadmap.md` entlang der Vertragsgrenze schaerfen
...
`spec/architecture.md` und ggf. `spec/hexagonal-port.md` werden nur dort
...
- `docs/user/releasing.md` beschreibt weiterhin nur den aktuellen
  GitHub-Release-/OCI-/Homebrew-Prozess und verweist Maven Central
  sichtbar auf `1.0.0`
- `docs/planning/roadmap.md` trennt `0.9.1` als Refactor-/Vorbereitungsstufe
...
- ggf. `spec/architecture.md`
- ggf. `spec/hexagonal-port.md`
- `settings.gradle.kts`
- `build.gradle.kts`

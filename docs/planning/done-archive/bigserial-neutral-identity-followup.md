...
- `docs/planning/done-archive/implementation-plan-0.4.0.md` beschreibt
  Identity-/Sequence-Support fuer Import/Sync. Das widerspricht nicht
  zwingend dem fehlenden `BIGSERIAL`-Forward-Mapping.
- `docs/planning/done-archive/change-request-spatial-types.md` enthaelt SQL-Beispiele
...
- `docs/planning/done-archive/ImpPlan-0.6.0-D-claude.md` ist historisch konsistent mit

...
> beiden Sub-Pläne [E2 — persistente JDBC-Adapter](../done-archive/ImpPlan-0.9.6-E2.md)
> und [E3 — Async-Executor Production-Tuning](../done-archive/ImpPlan-0.9.6-E3.md)
> sind ebenfalls abgeschlossen. Phase-E-Start war durch
> `docs/planning/done-archive/ImpPlan-0.9.6-E0-Gate-Decision.md` §1 freigegeben
...
> **Referenz**: `docs/planning/done-archive/implementation-plan-0.9.6.md`
...
> `docs/planning/done-archive/ImpPlan-0.9.6-A.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-B.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-C.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-D.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-E0.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-E0.7.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-E0-Side-Effect-Matrix.md`;
> `docs/planning/done-archive/ImpPlan-0.9.6-E0-Gate-Decision.md`; `spec/ki-mcp.md`;
...
- E0-Plan: [`docs/planning/done-archive/ImpPlan-0.9.6-E0.md`](../done-archive/ImpPlan-0.9.6-E0.md)
  (alle AP E0.1–E0.6 abgeschlossen, Move nach `done/` erfolgt).
- Side-Effect-Matrix:
  [`docs/planning/done-archive/ImpPlan-0.9.6-E0-Side-Effect-Matrix.md`](../done-archive/ImpPlan-0.9.6-E0-Side-Effect-Matrix.md)
  (final-klassifiziert nach E0.7.5: `go ~74`, `blocked = 0`).
- Gate-Decision:
  [`docs/planning/done-archive/ImpPlan-0.9.6-E0-Gate-Decision.md`](../done-archive/ImpPlan-0.9.6-E0-Gate-Decision.md)
  Verdict **`Go`** (initial `Blocked` 2026-05-05, re-stempelt nach
  E0.7.5).
- Pre-Phase-E-Auflösung E0.7:
  [`docs/planning/done-archive/ImpPlan-0.9.6-E0.7.md`](../done-archive/ImpPlan-0.9.6-E0.7.md)
...
- `data_import_start` und `data_transfer_start` sind Hauptplan §6.7 /
  §3.1 explizit Phase F (`docs/planning/done-archive/ImpPlan-0.9.6-F.md`).

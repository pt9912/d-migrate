...
> Abschnitt 7.3, Abschnitt 8.2, Abschnitt 9; `docs/planning/ImpPlan-0.7.5-A.md`;
...
- `spec/profiling.md` beschreibt fuer den Use-Case bereits:
  - `ProfileTableService`
  - `ProfileDatabaseService`
  - lokale Profiling-Exception-Hierarchie
- `docs/planning/implementation-plan-0.7.5.md` fixiert fuer Phase D:

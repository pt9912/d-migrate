...
> 0.9.7-Plan-Doc (`docs/planning/done-archive/diffresult-migration-plan.md`)
...
> `docs/planning/done-archive/diffresult-migration-plan.md`
...
> Carve-out-Plan unter `docs/planning/done-archive/ImpPlan-0.9.7-d.3b-materialized-views.md`.
...
> Functions Up + Down, plan in `../done-archive/ImpPlan-0.9.7-E.1-routine-migration.md`).
...
> renderbar. Plan-Doc: `docs/planning/done-archive/ImpPlan-0.9.7-E.2-trigger-rendering.md`
> mit dem A.3-Detail-Plan
> `docs/planning/done-archive/ImpPlan-0.9.7-E.2-A.3-hasgap-strict.md`.
...
- SQLite-Trigger-Reverse-Read aus `sqlite_master` ist seit 2026-05-22
  produktiv (siehe `docs/planning/done-archive/ImpPlan-0.9.7-sqlite-trigger-reverse-read.md`).
...
- Nutzung von Sequences in Defaults und deren Reverse-/Compare-
  ...
  Plan-Doc `docs/planning/done-archive/ImpPlan-0.9.7-sqlite-trigger-reverse-read.md`;
...
> Plan: `../done-archive/ImpPlan-0.9.7-F.4-rendering.md`.
...
- [x] Report- und Exit-Code-Erwartungen sind in Tests gepinnt.
  ...
  **Carve-out — `OBJECT_RENAME_UNSUPPORTED` (F.4)**: ✅ resolved
  ...
  `done-archive/ImpPlan-0.9.7-F.4-renderer-blocker-bridge.md`. Per-Dialekt-
...
- **Phase H aus dem ersten Plan-Doc** (SQLite-Rebuild-Vertrag) —
  ...
  `done-archive/diffresult-migration-plan.md`.

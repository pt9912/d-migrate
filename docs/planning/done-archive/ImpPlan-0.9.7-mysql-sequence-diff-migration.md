...
> **Referenz**: `docs/planning/done-archive/mysql-sequence-emulation-plan.md` (Vollvariante
...
(`docs/planning/done-archive/mysql-sequence-emulation-plan.md`, Phasen A–E2, abgeschlossen
...
- **SQLite-Sequence-Diff**: eigener Plan
  (`docs/planning/done-archive/sqlite-sequence-emulation-plan.md`). Dieser Slice ist
  MySQL-only.
...
| ------------ | ------ | --------- |
| `MysqlNamedSequenceMode.HELPER_TABLE`-Emulation | ✅ 0.9.4 AP 6.3/6.4 | Plan-Doc: `docs/planning/done-archive/mysql-sequence-emulation-plan.md` |

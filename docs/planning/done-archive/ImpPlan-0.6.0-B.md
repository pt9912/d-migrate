...
> **Referenz**: `docs/planning/implementation-plan-0.6.0.md` Abschnitt 2,
> Abschnitt 4.2 bis 4.7, Abschnitt 5 Phase B, Abschnitt 6.1 bis 6.3,
> Abschnitt 7, Abschnitt 8, Abschnitt 9, Abschnitt 10;
> `docs/planning/ImpPlan-0.6.0-A.md`; `spec/architecture.md`;
...
- die regulaere Spezifikation in `spec/neutral-model-spec.md` muss diese
...
- `spec/neutral-model-spec.md` wird fuer diese Aenderung synchron nachgezogen
...
- [x] `spec/neutral-model-spec.md` widerspricht der `E008`-Herabstufung nach
      Phase B nicht mehr.
...
7. Gegenlesen von `spec/neutral-model-spec.md`, dass die PK-Regel nicht mehr im
...
Wenn `spec/neutral-model-spec.md` die `E008`-Herabstufung nicht mittraegt,

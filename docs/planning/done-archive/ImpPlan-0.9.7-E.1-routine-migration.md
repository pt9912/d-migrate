...
- Routine-Rename — gehoert zum spaeteren F.4-Routine-Trigger-View-
  Rename-Slice (`docs/planning/done-archive/ImpPlan-0.9.7-F.4-routine-trigger-view-renames.md`),
...
- MySQL-Reverse-Read von Routine-Identity-Attributen
  ...
  [`done-archive/ImpPlan-0.9.7-mysql-routine-identity-reverse-read.md`](./ImpPlan-0.9.7-mysql-routine-identity-reverse-read.md).
- Konfigurierbare Capability-Quelle (CLI / YAML) — Defaults sind
  ...
  Slice; Folge-Plan
  [`done-archive/ImpPlan-0.9.7-routine-capability-configurable-source.md`](./ImpPlan-0.9.7-routine-capability-configurable-source.md).
...
- [x] PostgreSQL-Renderer fuer Function + Procedure rendert
  ...
  - [x] MySQL-Renderer schreibt Routine-Bodies ohne `DELIMITER` im
    ...
    - Der reservierte InvalidConfig-Pfad erzwingt `ROUTINE_CAPABILITY_CONFIG_INVALID`
      ...
      `done-archive/ImpPlan-0.9.7-routine-capability-configurable-source.md` beschrieben.

...
> `done-archive/diffresult-migration-plan-2.md`.
...
> Vorarbeit:
> - `docs/planning/done-archive/ImpPlan-0.9.7-sequence-preserve-current-value.md` §3.2
...
Roadmap §0.9.7 + `done-archive/diffresult-migration-plan-2.md` §14.1

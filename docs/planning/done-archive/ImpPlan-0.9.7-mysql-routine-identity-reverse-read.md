...
> **Vorbedingung**: E.1 ✅ (`docs/planning/done-archive/ImpPlan-0.9.7-E.1-routine-migration.md`)
> **Referenz**: `docs/planning/done-archive/ImpPlan-0.9.7-E.1-routine-migration.md` §2
>             (Aus-Scope-Carve-out)

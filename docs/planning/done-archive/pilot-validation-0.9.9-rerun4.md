...
- **Bewusste Nicht-Ziele — nicht als Bug gewertet:** K2 (Routinen-Ordering), N7,
  N8 (P3-Tracker [`pilot-rerun-p3-residuals.md`](../done/pilot-rerun-p3-residuals.md));
...
[`pilot-rerun-p3-residuals.md`](../done/pilot-rerun-p3-residuals.md)). Mit L1
...
- [Erstlauf](pilot-validation-0.9.9.md) · [Re-Run 1](pilot-validation-0.9.9-rerun.md) · [Re-Run 2](pilot-validation-0.9.9-rerun2.md) · [Re-Run 3](pilot-validation-0.9.9-rerun3.md) · [P3-Restbefunde](../done/pilot-rerun-p3-residuals.md)

...
> **Referenz**: `docs/planning/implementation-plan-0.9.4.md` Abschnitt 6.5,
...
- `docs/planning/roadmap.md` beschreibt 0.9.4 mit dem tatsaechlichen Scope fuer
  Reverse, Compare und `W116`
- `docs/planning/mysql-sequence-emulation-plan.md` zieht Phase D/E vom offenen
  Plan in einen umgesetzungsnahen Vertragsstand
- `spec/cli-spec.md` dokumentiert `schema reverse`, `schema compare`
  und `W116` im 0.9.4-Vertrag korrekt
- `docs/user/guide.md` und `ledger/warn-code-ledger-0.9.4.yaml` stehen
...
- `docs/planning/roadmap.md` enthaelt den groben Milestone-Scope und verweist auf
  den Sequence-Plan
- `docs/planning/mysql-sequence-emulation-plan.md` fuehrt Phase D/E noch als
  offen bzw. fuer 0.9.4 geplant
- `spec/cli-spec.md` dokumentiert CLI-Vertraege, fuehrt `W116` aber
  noch als reserviert
- `docs/user/guide.md` enthaelt generische Hinweise zu `schema reverse` und
...
- `spec/cli-spec.md` spricht bei `W116` noch von "reserviert", obwohl
  das 0.9.4-Ledger bereits `active` fuehrt
- `docs/planning/mysql-sequence-emulation-plan.md` markiert Phase D/E noch als
  offen, statt den konkreten 0.9.4-Vertrag aus D1 bis E1 abzubilden
- `docs/user/guide.md` erklaert weder Sequence-Reverse noch Compare-
  Sichtbarkeit fuer degradierte Operanden konkret
- `docs/planning/roadmap.md` beschreibt 0.9.4 auf Milestone-Ebene, aber noch
...
- `spec/cli-spec.md` darf fuer `schema reverse` und `schema compare`
...
- `docs/user/guide.md` bekommt nur die nutzerrelevanten Hinweise:
...
- `docs/planning/mysql-sequence-emulation-plan.md` und
  `docs/planning/implementation-plan-0.9.4.md` duerfen nach E2 nicht mehr
  auseinanderlaufen bei:
  - Phase-D/E-Status
  - `W116`-Bedeutung
  - Compare-Rolle
- `docs/planning/implementation-plan-0.9.4.md` gilt dabei in E2 als bereits
...
- `docs/planning/roadmap.md` fuer den 0.9.4-Status aktualisieren
...
- `docs/planning/mysql-sequence-emulation-plan.md` Phase D/E auf den 0.9.4-
...
- `spec/cli-spec.md` fuer `schema reverse`, `schema compare` und
  `W116` aktualisieren
...
- `docs/user/guide.md` um praxisnahe Hinweise zu MySQL-Sequence-Reverse und
...
- `rg -n "W116.*[Rr]eserviert|[Rr]eserviert.*W116" spec/cli-spec.md`
  liefert nach E2 keinen Treffer mehr
- `rg -n "W116" docs/user/guide.md` liefert nach E2 mindestens einen
  nutzerrelevanten Treffer
- `rg -n "reverse|Reverse" docs/user/guide.md` liefert nach E2 mindestens
  einen Reverse-bezogenen Nutzerhinweis
- `rg -n "sourceOperand|targetOperand" spec/cli-spec.md` liefert nach
...
- `rg -n "status:\\s*active|status: active" ledger/warn-code-ledger-0.9.4.yaml`
  und `rg -n "W116" spec/cli-spec.md` liefern konsistent den aktiven
  0.9.4-Stand
...
- `docs/planning/implementation-plan-0.9.4.md`
- `docs/planning/ImpPlan-0.9.4-6.1.md`
- `docs/planning/ImpPlan-0.9.4-6.2.md`
- `docs/planning/ImpPlan-0.9.4-6.3.md`
- `docs/planning/ImpPlan-0.9.4-6.4.md`

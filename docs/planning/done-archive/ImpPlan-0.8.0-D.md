...
> **Referenz**: `docs/planning/implementation-plan-0.8.0.md` Abschnitt 2, Abschnitt 3,
> Abschnitt 4.4, Abschnitt 4.6, Abschnitt 5.1, Abschnitt 5.4, Abschnitt 6
> Phase D, Abschnitt 7, Abschnitt 8, Abschnitt 9; `docs/planning/ImpPlan-0.8.0-A.md`;
> `docs/planning/ImpPlan-0.8.0-B.md`; `docs/planning/roadmap.md` Milestone 0.8.0;
> `spec/architecture.md` Abschnitt 9 Internationalisierung;
> `spec/connection-config-spec.md` Abschnitt `i18n.normalize_unicode`;
...
- [ ] Die Phase bleibt kompatibel mit `docs/planning/ImpPlan-0.8.0-A.md`,
      `docs/planning/ImpPlan-0.8.0-B.md`, `docs/planning/ImpPlan-0.8.0-C.md` und dem
      0.8.0-Masterplan.

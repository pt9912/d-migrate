...
- **Bewusste Nicht-Ziele — nicht als Bug gewertet:** N7 (Custom-Aggregat von
  ...
  [`pilot-rerun-p3-residuals.md`](../done/pilot-rerun-p3-residuals.md) getrackt;
...
- [Erstlauf](pilot-validation-0.9.9.md) · [Re-Run 1](pilot-validation-0.9.9-rerun.md) · [P2-Blocker-Tracker](pilot-blocker-p2-tracker.md) · [P3-Restbefunde](../done/pilot-rerun-p3-residuals.md)

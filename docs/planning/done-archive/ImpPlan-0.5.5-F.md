...
> `docs/planning/ImpPlan-0.5.5-B.md`; `docs/planning/ImpPlan-0.5.5-C.md`;
> `docs/planning/ImpPlan-0.5.5-D.md`; `docs/planning/ImpPlan-0.5.5-E.md`;
> `spec/ddl-generation-rules.md`; `spec/cli-spec.md`
...
Parallel-Arbeit gemaess `spec/hexagonal-port.md` bereits nach

...
> Abschnitt 8, Abschnitt 11, Abschnitt 12; `docs/planning/ImpPlan-0.7.5-A.md`;
> `docs/planning/ImpPlan-0.7.5-B.md`; `docs/planning/roadmap.md` Milestone 0.7.5;
...
- Phase B definiert den fachlichen Profiling-Kern:
  ...
  - `WarningEvaluator`
- `spec/profiling.md` beschreibt fuer den Adapterlayer bereits ein groesseres
  Zielbild mit:
...
- `docs/planning/implementation-plan-0.7.5.md` reduziert den produktiven 0.7.5-Scope
  bewusst auf:
...
- keine sample-basierten Pattern-Statistiken als Pflichtbestandteil dieser
  Phase
- kein spaeterer Zuschnitt von `spec/profiling.md` darf rueckwirkend so
...
`spec/profiling.md` enthaelt mehr als der 0.7.5-Kern. Ohne harte Begrenzung

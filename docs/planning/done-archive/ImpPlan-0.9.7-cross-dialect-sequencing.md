...
>                  *(done, `docs/planning/done-archive/ImpPlan-0.9.7-mysql-sequence-diff-migration.md`)*;
>                  preserveCurrentValue-Slice
>                  *(done, `docs/planning/done-archive/ImpPlan-0.9.7-sequence-preserve-current-value.md`)*;
>                  SQLite-Sequence-Plan
>                  (`docs/planning/done-archive/sqlite-sequence-emulation-plan.md`, weiter offen).
...
- **SQLite** (parallel-Plan): rebuild-basierte Emulation; Details
  in `docs/planning/done-archive/sqlite-sequence-emulation-plan.md`.
...
5. **Cross-Dialect-Rename**: ein `RenameSequence` auf PG ist nativ;
   ...
   blockiert (`docs/planning/done-archive/ImpPlan-0.9.7-F.4-routine-trigger-view-renames.md`
...
- Konkretes MySQL-Render-DDL → `docs/planning/done-archive/ImpPlan-0.9.7-mysql-sequence-diff-migration.md`.
- Konkretes SQLite-Render-DDL → `docs/planning/done-archive/sqlite-sequence-emulation-plan.md`.
...
| E | Closing: Plan-Doc nach `docs/planning/done-archive/ImpPlan-0.9.7-cross-dialect-sequencing.md`; Cross-Links in die drei dialekt-spezifischen Plans setzen |
...
- **SQLite-Plan ist offen**: solange `docs/planning/done-archive/sqlite-sequence-emulation-plan.md`

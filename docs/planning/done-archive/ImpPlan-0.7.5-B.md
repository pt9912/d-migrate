...
- Phase A definiert fuer 0.7.5 bereits:
  ...
  - klar reduzierten Milestone-Scope gegenueber `spec/profiling.md`
...
- `spec/profiling.md` beschreibt bereits ein ausgebautes Zielbild mit:
  - Kernmodell
  - Statistiktypen
  - Warning-Regeln
  - Struktur-Findings
...
- `docs/planning/implementation-plan-0.7.5.md` grenzt fuer den produktiven 0.7.5-
  Vertrag bewusst ein:
...
Phase B fuehrt nicht das komplette Endbild aus `spec/profiling.md` ein.
...
### R1 - Modell driftet zu nah an `spec/profiling.md` als Gesamtendbild

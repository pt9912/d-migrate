...
> **Referenz**: `docs/planning/implementation-plan-0.6.0.md` Abschnitt 4.2 bis 4.10,
> Abschnitt 5 Phase D, Abschnitt 6.1 bis 6.4, Abschnitt 7, Abschnitt 8,
> Abschnitt 9, Abschnitt 10; `docs/planning/ImpPlan-0.6.0-B.md`;
> `docs/planning/ImpPlan-0.6.0-C.md`; `spec/neutral-model-spec.md`
...
- `spec/neutral-model-spec.md` muss fuer 0.6.0 explizit nachziehen, dass
...
- `spec/neutral-model-spec.md` reserviert den Prefix
...
- `spec/neutral-model-spec.md` als kanonischer Spezifikationsnachzug fuer
...
- `spec/neutral-model-spec.md` widerspricht der technischen
...
- Spezifikations-Gegenpruefung in `spec/neutral-model-spec.md`, dass technische

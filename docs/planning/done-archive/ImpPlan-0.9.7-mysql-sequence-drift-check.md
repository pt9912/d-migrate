...
> **Referenz**: `docs/planning/done-archive/ImpPlan-0.9.7-mysql-sequence-diff-migration.md`
>             §3.1 (ursprünglicher Scope mit Drift-Check),
>             §10.1 (Schicht-1-Idempotenz vs. Schicht-2-Drift),
>             `docs/planning/done-archive/ImpPlan-0.9.7-F.5-check-exclude-vollscheibe.md`

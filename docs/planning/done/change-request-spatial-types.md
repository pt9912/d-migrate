...
>
> Siehe [roadmap.md, Milestone 0.5.5 — Erweitertes Typsystem](../in-progress/roadmap.md#milestone-055--erweitertes-typsystem--2026-04-13).
...
>
> - `spec/neutral-model-spec.md` — Typdefinition `geometry`, Attribute `geometry_type` und `srid`, Validierungsregeln E120/E121
> - `spec/ddl-generation-rules.md` — Spatial-DDL-Regeln pro Dialekt, Spatial-Profile, E052 und W120
> - `spec/cli-spec.md` — Flag `--spatial-profile`, Dialekt-Defaults, Fehlercodes
> - `spec/architecture.md` — Generator-Options-Pfad, Verortung von `spatialProfile`
>

...
`docs/user/quality.md` nennt fuer 0.9.2 zwei konkrete Hotspots:
...
- `docs/user/quality.md` darf die Hotspots nach Umsetzung nicht mehr als
...
### 10.7 Schritt G — `docs/user/quality.md` aktualisieren

...
> Referenzen: `docs/planning/roadmap.md` Abschnitt "Milestone 0.9.4",
> `docs/planning/mysql-sequence-emulation-plan.md` Abschnitt 6,
> `docs/planning/implementation-plan-0.9.3.md`,
...
- `docs/planning/roadmap.md` fuer 0.9.4-Status aktualisieren
- `docs/planning/mysql-sequence-emulation-plan.md` Phase D/E auf
  Umsetzungsstand ziehen
- `spec/cli-spec.md` fuer Reverse-/Compare-Vertrag und `W116`
  konkretisieren
- `docs/user/guide.md` um Reverse-/Compare-Hinweise fuer MySQL-Sequences
  ergaenzen

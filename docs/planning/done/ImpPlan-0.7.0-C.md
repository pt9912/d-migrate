...
> `spec/cli-spec.md`; `spec/design.md`; `spec/architecture.md`;
...
- `spec/cli-spec.md` ist fuer 0.7.0 bereits auf den finalen Exportvertrag
  nachgezogen:
  - `--target` ist Pflicht
  - Django/Knex verlangen explizites `--version`
  - Rollback ist tool-spezifisch
- `spec/design.md` beschreibt fuer 0.7.0 bereits die gewollten

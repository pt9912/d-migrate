...
`spec/job-contract.md` ist fuer Jobs und Artefakte verbindlich. Phase A darf
...
### 4.3 Job- und Artefaktmodell kommt aus `spec/job-contract.md`
...
protokollneutralen Modelle aus `spec/job-contract.md`. Store-Records muessen
...
- Job-/Artefaktfelder gegen `spec/job-contract.md` abgleichen
...
- komplettes Kern-Code-Vokabular aus `spec/ki-mcp.md` abbilden:
...
- Job- und Artefaktmodelle aus `spec/job-contract.md` wiederverwendet
  werden
...
- Error-Mapping fuer das vollstaendige Kern-Code-Vokabular aus
  `spec/ki-mcp.md` deterministisch ist, inklusive Auth, Policy,
...
`spec/architecture.md` 1.2 legt fest:
...
| `ManagedJob` | `...core.job` | data class (oeffentlicher Vertrag aus `spec/job-contract.md`) |
...
| 6.7 | `ErrorMapperTest` (parametrisiert pro Code: alle 18 Codes aus `spec/ki-mcp.md`), `ValidationErrorMapperTest`, `AppExceptionHierarchyTest` |
...
Modulplatzierung gemaess `spec/architecture.md` 1.2:

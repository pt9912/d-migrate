...
> **Referenz**: `docs/planning/implementation-plan-0.7.5.md` Abschnitt 1, Abschnitt 2,
> Abschnitt 3, Abschnitt 4, Abschnitt 5, Abschnitt 6 Phase A, Abschnitt 7,
> Abschnitt 9, Abschnitt 11, Abschnitt 12; `docs/planning/roadmap.md` Milestone 0.7.5;
> `spec/profiling.md`; `spec/design.md` Abschnitt 3.6;
...
- dass 0.7.5 bewusst nur den deterministischen Kern des Profilings liefert
  und nicht das volle Zielbild aus `spec/profiling.md`
...
- dass die Doku-Luecke fuer `data profile` in `spec/cli-spec.md` als Teil des
...
- `docs/planning/roadmap.md` definiert fuer 0.7.5:
...
- `spec/profiling.md` beschreibt bereits ein deutlich groesseres Zielbild
  inklusive:
  - Query-Profiling
  - Normalisierungsanalyse
  - Struktur-Findings
  - spaeterer semantischer Analyse
- `docs/planning/implementation-plan-0.7.5.md` reduziert diesen Zielraum bereits
...
- `spec/cli-spec.md` enthaelt derzeit noch keinen Abschnitt fuer
...
- finale Produktivpflege von `spec/cli-spec.md`, `spec/design.md` oder
...
- `spec/profiling.md` bleibt groesseres Zielbild
...
`spec/cli-spec.md` kennt aktuell noch keinen Vertrag fuer `data profile`.
...
Phase A dokumentiert explizit, dass `spec/cli-spec.md` fuer 0.7.5 spaeter
...
- [x] Es ist dokumentiert, dass `spec/cli-spec.md` spaeter um
...
### R2 - Scope-Drift aus `spec/profiling.md`
...
- [x] Die Doku-Luecke fuer `data profile` in `spec/cli-spec.md` ist als

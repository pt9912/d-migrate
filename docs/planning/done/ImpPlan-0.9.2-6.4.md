...
> **Referenz**: `docs/planning/implementation-plan-0.9.2.md` Abschnitt 4.4,
...
> `docs/planning/ImpPlan-0.9.2-6.2.md`;
> `docs/planning/ImpPlan-0.9.2-6.3.md`.
...
### 5.5 `spec/cli-spec.md` auf den fertigen Output-Vertrag ziehen
...
- `docs/planning/ImpPlan-0.9.2-6.2.md`, falls Zwischenverhalten in Doku-Referenzen
  angepasst werden muss
- `docs/planning/ImpPlan-0.9.2-6.3.md`, falls neue Report-/JSON-Beispiele den

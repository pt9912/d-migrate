...
>                  (`docs/planning/done/sqlite-sequence-emulation-plan.md`, weiter offen).
...
- **SQLite** (parallel-Plan): rebuild-basierte Emulation; Details
  in `docs/planning/done/sqlite-sequence-emulation-plan.md`.
...
- Konkretes SQLite-Render-DDL → `docs/planning/done/sqlite-sequence-emulation-plan.md`.
...
- **SQLite-Plan ist offen**: solange `docs/planning/done/sqlite-sequence-emulation-plan.md`

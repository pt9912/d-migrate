...
> Abschnitt 7, Abschnitt 8, Abschnitt 10; `docs/planning/ImpPlan-0.5.5-D.md`;
> `docs/planning/change-request-spatial-types.md`; `spec/ddl-generation-rules.md`;
> `spec/cli-spec.md`
...
- `docs/planning/ImpPlan-0.5.5-D.md`, weil Phase E den dort definierten Profil- und
  Outputvertrag konsumiert
- `spec/ddl-generation-rules.md`, falls Rollback- oder SQLite-Spatialregeln
...
- PostgreSQL-/MySQL-Rollback ist in Implementierung, Tests und
  `spec/ddl-generation-rules.md` widerspruchsfrei auf denselben kanonischen
  Pfad gezogen

...
> `docs/planning/ImpPlan-0.9.0-A.md`; `docs/planning/ImpPlan-0.9.0-B.md`;
> `docs/planning/ImpPlan-0.9.0-C.md`; `docs/planning/ImpPlan-0.9.0-D.md`;
> `spec/cli-spec.md`; `spec/connection-config-spec.md`;
> `docs/planning/roadmap.md`; `docs/user/guide.md`; `spec/design.md`;
...
- Gleichzeitig haengen mehrere normative Texte und Kommentare noch an
  Zwischenstaenden:
  - `spec/cli-spec.md` verwendet fuer Resume teils noch "Phase B/C"
  - `docs/user/guide.md` referenziert Export- und Import-Resume ebenfalls noch
    als Phase-B/C-Fortsetzung
  - `docs/planning/roadmap.md` traegt bewusst einen Ist-Stand-Kasten aus Phase A,
    muss fuer den finalen 0.9.0-Zustand aber erneut synchronisiert werden
  - `spec/design.md` und `spec/architecture.md` enthalten vorlaufende
...
- Aktualisierung der normativen Doku:
  ...
  - `docs/user/guide.md`
  - gezielte Verweise in `spec/design.md` und `spec/architecture.md`
...
- `spec/connection-config-spec.md` muss den produktiven 0.9.0-Vertrag fuer
  `pipeline.checkpoint.*` beschreiben, nicht nur eine Vorab-Skizze
- `spec/design.md` und `spec/architecture.md` duerfen weiterhin abstrakter
...
- `spec/cli-spec.md` auf den finalen 0.9.0-Resume- und I18n-Vertrag ziehen
- `spec/connection-config-spec.md` fuer Checkpoint-Namen, Trigger und
  Prioritaeten vervollstaendigen
- `docs/planning/roadmap.md` vom Phase-A-Ist-Stand auf den finalen 0.9.0-Stand
  nachziehen
- `docs/user/guide.md` fuer sichtbare Nutzerpfade und 0.9.0-Limitationen
  aktualisieren
- Referenzen in `spec/design.md` und `spec/architecture.md` gezielt an den
  produktiven Port-/Manifestvertrag rueckbinden

### 5.5 E5 - Abschlussabgleich gegen Teilplaene und Masterplan

- pruefen, dass Teilplaene A bis D und `docs/planning/implementation-plan-0.9.0.md`
...
- `spec/cli-spec.md`, `docs/user/guide.md` und `docs/planning/roadmap.md` widersprechen
  den Teilplaenen nicht mehr
- `spec/connection-config-spec.md` beschreibt den produktiven 0.9.0-
  Checkpoint-Vertrag klar
- `spec/design.md` und `spec/architecture.md` verweisen nicht mehr nur auf
...
- `docs/planning/ImpPlan-0.9.0-E.md`

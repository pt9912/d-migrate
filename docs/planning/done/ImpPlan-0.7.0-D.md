...
> `docs/planning/ImpPlan-0.7.0-C.md`; `spec/cli-spec.md`; `spec/design.md`;
> `spec/architecture.md`; `spec/lastenheft-d-migrate.md` LF-011 / LF-014
...
- `spec/cli-spec.md` fixiert fuer 0.7.0 bereits den finalen CLI-Vertrag:
...
- Bei `--report` wird ein Sidecar geschrieben, das mindestens den in
  Masterplan und `spec/cli-spec.md` beschriebenen Mindestvertrag erfuellt:
  - Notes
  - `skippedObjects`
...
- [x] `export --help`, `export flyway --help`, `export liquibase --help`,
      ...
      konsistent zu `spec/cli-spec.md`.

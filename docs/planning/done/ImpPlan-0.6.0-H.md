...
> **Referenz**: `docs/planning/implementation-plan-0.6.0.md` Abschnitt 5 Phase H,
> Abschnitt 7, Abschnitt 8, Abschnitt 9, Abschnitt 10, Abschnitt 11;
> `docs/planning/ImpPlan-0.6.0-A.md`; `docs/planning/ImpPlan-0.6.0-D.md`;
> `docs/planning/ImpPlan-0.6.0-E.md`; `docs/planning/ImpPlan-0.6.0-F.md`;
> `docs/planning/ImpPlan-0.6.0-G.md`; `spec/cli-spec.md`;
> `spec/neutral-model-spec.md`; `spec/architecture.md`;
> `spec/design.md`; `docs/user/releasing.md`
...
- `docs/user/releasing.md` nutzt diese Fixture-Schemas bereits fuer
...
- `spec/cli-spec.md` beschreibt Reverse, Compare-DB-Operanden und Transfer
  bereits als 0.6.0-Soll
- `spec/neutral-model-spec.md` ist fuer den Live-DB-first-Reverse-Pfad bereits
  in Richtung 0.6.0 bereinigt
- `spec/architecture.md` und `spec/design.md` beschreiben Fixtures noch mit
  ...
  liegt
- `docs/user/releasing.md` hat bisher nur Schema-Generate-Smokes gegen die
...
- kanonische Beispielbasis fuer 0.6.0 bleibt:
  - `adapters/driven/formats/src/test/resources/fixtures/schemas/`
- bestehende Release-Smokes in `docs/user/releasing.md` werden erweitert, statt
...
- die kanonische Spezifikation bleibt in `spec/cli-spec.md`
- das Datenmodell bleibt in `spec/neutral-model-spec.md`
- Architekturrand und Modul-/Fixture-Einordnung bleiben in
  `spec/architecture.md`
- das Living Design in `spec/design.md` bleibt fuer das Zielbild konsistent
- reproduzierbare manuelle Smokes fuer Releases bleiben in `docs/user/releasing.md`
...
- `spec/cli-spec.md` auf den finalen Reverse-/Compare-/Transfer-Vertrag
  ziehen
- `spec/neutral-model-spec.md` gegen den realen Reverse- und Round-Trip-
  Vertrag pruefen
- `spec/architecture.md` auf reale Fixture-/Testpfade und 0.6.0-Status
  abgleichen
- `spec/design.md` auf denselben Fixture-/Beispielpfad und denselben
  0.6.0-Stand ziehen
- `docs/user/releasing.md` um Reverse-/Compare-/Transfer-Smokes erweitern
...
- [ ] Gezielte Integrationstests gegen reale Dialekte bleiben fuer 0.6.0 Teil
      der Verifikation.
- [ ] `spec/cli-spec.md`, `spec/neutral-model-spec.md`,
      `spec/architecture.md`, `spec/design.md` und `docs/user/releasing.md`
...
- [ ] `docs/user/releasing.md` enthaelt neben `schema generate` auch belastbare
...
- [ ] `docs/user/releasing.md` nutzt fuer CLI-Smokes ein finales Runtime-Image;
...
- CLI-Smokes laufen gegen das finale Runtime-Image statt gegen ein reines
  Build-Stage-Image
- `docs/user/releasing.md` ist mit den tatsaechlich lauffaehigen Smoke-Kommandos
  nachgefuehrt

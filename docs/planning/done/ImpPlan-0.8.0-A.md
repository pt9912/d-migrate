...
> **Referenz**: `docs/planning/implementation-plan-0.8.0.md` Abschnitt 1, Abschnitt 2,
> Abschnitt 3, Abschnitt 4, Abschnitt 5.2 bis 5.4, Abschnitt 6 Phase A,
> Abschnitt 8, Abschnitt 9; `docs/planning/roadmap.md` Milestone 0.8.0 und 0.9.0;
> `spec/design.md` Abschnitt 9; `spec/architecture.md` (`I18nConfig`,
> ICU4J); `spec/cli-spec.md`; `spec/connection-config-spec.md`;
...
- `docs/planning/roadmap.md` definiert fuer 0.8.0:
...
- `spec/cli-spec.md` listet `--lang` weiterhin als globales Flag, macht die
...
- `spec/design.md`, `spec/architecture.md` und
  `spec/connection-config-spec.md` sind inzwischen auf englisches
  Root-/Fallback-Bundle und `en` als Default-Locale abgeglichen.
- `spec/connection-config-spec.md` enthaelt bereits den kanonischen I18n-Block
  mit:
  - `i18n.default_locale`
...
- `spec/cli-spec.md` darf `--lang` nicht so beschreiben, als sei die gesamte
...
- `docs/planning/implementation-plan-0.8.0.md`, `spec/cli-spec.md`,
  `spec/architecture.md` und `spec/connection-config-spec.md` muessen hier
...
- `spec/design.md` stuetzt das 0.8.0-Zielbild, statt mit Root-Bundle- und
  Default-Locale-Aussagen dagegenzulaufen

### A.3 `spec/connection-config-spec.md`
...
### A.5 `docs/planning/implementation-plan-0.8.0.md`
...
- `docs/planning/implementation-plan-0.8.0.md`
...
- [x] `spec/cli-spec.md` unterscheidet sauber zwischen technischer
      0.8.0-I18n-Basis und finalem 0.9.0-`--lang`-Vertrag.
- [x] `spec/cli-spec.md` beschreibt `--lang` nicht mehr als stillen No-op,
      aber auch nicht als vollstaendig abgeschlossenen 0.8.0-Endvertrag.
- [x] `spec/cli-spec.md` fixiert, dass JSON-/YAML-Feldnamen und andere
...
- [x] Fuer strukturierte Fehlerausgaben ist dokumentiert, dass freie
      ...
      bleiben.
- [x] `spec/design.md`, `spec/architecture.md` und
      `spec/connection-config-spec.md` widersprechen sich nicht mehr beim
...
- [x] `docs/planning/implementation-plan-0.8.0.md` und dieser Teilplan beschreiben
...
1. Querlesen von `spec/cli-spec.md`, `spec/design.md`,

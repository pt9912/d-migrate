...
> `docs/user/quality.md`; `docs/planning/ddl-output-split-plan.md`;
...
Phase B zieht die wartungskritischen Grossklassen aus `docs/user/quality.md`
...
Laut `docs/user/quality.md` und dem 0.9.1-Masterplan sind fuer Phase B vor
allem diese Punkte relevant:

- **Mittel**: `DataImportRunner` liegt aktuell bei 949 LOC
  (Stand 2026-04-17; das in `docs/user/quality.md` zitierte 887-LOC-Finding
...
- sie adressiert die groessten Wartungs-Hotspots aus `docs/user/quality.md`

...
| Die **25 bekannten Befunde** des Silent-Loss-Checks — 19 auf [Plan 2](../done/reader-treue-2-meldungen.md), 1 auf [Plan 4](../next/reader-treue-4-mssql-berechneter-typ.md) (D1), 5 auf den SQLite-Eintrag oben. **Stand 2026-09-18:** Plan 2 hat 18 davon gestrichen, die Liste trägt noch **7** | die Liste ist Code: `SILENT_LOSS_KNOWN` in [`examples/mcp-e2e/scripts/lib/silent-loss.sh`](../../../examples/mcp-e2e/scripts/lib/silent-loss.sh); jeder Eintrag nennt sein Paket, und ein Eintrag, der im Lauf nicht auftritt, macht ihn rot |

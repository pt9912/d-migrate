...
> **Referenz**: `docs/planning/implementation-plan-0.9.0.md` Abschnitt 2 bis 6.2,
> Abschnitt 8.1 bis 8.3; `docs/planning/ImpPlan-0.9.0-A.md`; `spec/design.md`
> Abschnitt 3.2; `spec/architecture.md` Abschnitt 3.3;
> `spec/connection-config-spec.md` (`pipeline.checkpoint.*`);
> `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/PipelineConfig.kt`;
> `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/ProgressEvent.kt`;
> `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/ExportResult.kt`;
> `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/ImportResult.kt`;
...
- `spec/design.md` enthaelt mit `MigrationCheckpoint` bereits eine
  Konzeptklasse fuer Resume, die im Produktionscode aber noch nicht
  existiert.
- `spec/architecture.md` skizziert einen `CheckpointStore` in einer
  allgemeinen Streaming-Pipeline, ohne dass dieser Port derzeit im
  Hexagon vorhanden waere.
- `spec/connection-config-spec.md` dokumentiert bereits:
...
- Doku: `spec/connection-config-spec.md` dokumentiert
...
- `docs/planning/implementation-plan-0.9.0.md`
- `docs/planning/ImpPlan-0.9.0-A.md`
- `docs/planning/ImpPlan-0.9.0-B.md`
- `spec/connection-config-spec.md`
- `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/PipelineConfig.kt`
- `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/ProgressEvent.kt`
- `hexagon/ports-write/src/main/kotlin/dev/dmigrate/streaming/ExportResult.kt`

...
> Phase D, Abschnitt 7, Abschnitt 8, Abschnitt 9.2; `spec/cli-spec.md`
> Abschnitt 7; `docs/planning/implementation-plan-0.4.0.md` Abschnitt 6.11
...
- `spec/cli-spec.md` Abschnitt 7 zeigt aktuell eine Fortschrittsanzeige mit
...
- Doku-Abgleich in `spec/cli-spec.md` Abschnitt 7
...
| `spec/cli-spec.md` | Fortschrittsabschnitt auf line-orientierten MVP und echte Flag-Semantik abgleichen |
...
`spec/cli-spec.md` Abschnitt 7 wird auf den tatsaechlichen MVP-Vertrag
umgestellt.
...
- `spec/cli-spec.md` Abschnitt 7 beschreibt danach den tatsaechlichen

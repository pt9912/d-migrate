...
> `docs/planning/ImpPlan-0.8.0-C.md`; `docs/planning/ImpPlan-0.8.0-D.md`;
> `docs/planning/ImpPlan-0.8.0-E.md`; `docs/planning/ImpPlan-0.8.0-F.md`;
> `spec/cli-spec.md`; `spec/design.md`;
> `spec/connection-config-spec.md`; `docs/user/guide.md`;
...
- `spec/cli-spec.md`, `spec/design.md` und `spec/connection-config-spec.md`
  spiegeln den 0.8.0-Wortlaut
- `docs/user/guide.md` ist fuer `--lang` auf den getesteten 0.8.0-Vertrag
...
- `docs/user/guide.md` ist fuer den 0.8.0/0.9.0-Grenzverlauf bei `--lang`

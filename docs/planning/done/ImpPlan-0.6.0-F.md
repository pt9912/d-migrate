...
> **Referenz**: `docs/planning/implementation-plan-0.6.0.md` Abschnitt 4.4,
> Abschnitt 5 Phase F, Abschnitt 6.2, Abschnitt 6.3, Abschnitt 7,
> Abschnitt 8, Abschnitt 9, Abschnitt 10; `docs/planning/ImpPlan-0.6.0-A.md`;
> `docs/planning/ImpPlan-0.6.0-B.md`; `docs/planning/ImpPlan-0.6.0-D.md`;
> `docs/planning/ImpPlan-0.6.0-E.md`; `spec/cli-spec.md`;
...
- Nachfuehrung von `spec/cli-spec.md` auf den finalen Phase-F-Vertrag
...
- [ ] `spec/cli-spec.md` beschreibt denselben Compare-Vertrag wie der Code.

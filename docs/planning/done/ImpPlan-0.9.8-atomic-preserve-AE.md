...
Test-Decorator-Workaround aus `done/atomic-preserve-followups.md`
...
- `docs/planning/done/atomic-preserve-followups.md` §8.2 Finding
...
- Diese Closure (`docs/planning/done/ImpPlan-0.9.8-atomic-preserve-AE.md`)

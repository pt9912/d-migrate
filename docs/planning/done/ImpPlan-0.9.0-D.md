...
> bis 8.3; `docs/planning/ImpPlan-0.9.0-A.md`; `docs/planning/ImpPlan-0.9.0-B.md`;
> `spec/cli-spec.md` `data import`;
...
- `spec/cli-spec.md` dokumentiert den sichtbaren 0.9.0-Resume-Einstieg
...
- der Runner-Text und die Import-Stelle in `spec/cli-spec.md` werden von
...
- `spec/cli-spec.md` fuer `data import` auf den produktiven Phase-D-Vertrag
  aktualisieren
...
- [x] `spec/cli-spec.md` + `docs/user/guide.md` Import-Abschnitte auf
...
- `spec/cli-spec.md` nennt fuer `data import` die korrekte Phasenreferenz
...
- `docs/planning/ImpPlan-0.9.0-D.md`
- `spec/cli-spec.md`
- `adapters/driving/cli/src/main/kotlin/dev/dmigrate/cli/commands/DataImportCommand.kt`
- `hexagon/application/src/main/kotlin/dev/dmigrate/cli/commands/DataImportRunner.kt`
- `adapters/driven/streaming/src/main/kotlin/dev/dmigrate/streaming/StreamingImporter.kt`

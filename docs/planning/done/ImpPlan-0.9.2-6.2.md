...
> **Referenz**: `docs/planning/implementation-plan-0.9.2.md` Abschnitt 4.2,
...
- Help-Text und `spec/cli-spec.md` beschreiben den Split-Vertrag noch
  nicht
...
- Help-Text, Fehlermeldungen und `spec/cli-spec.md` auf denselben
  Vertrag ziehen
...
- Help-Text, Command-Doku und `spec/cli-spec.md` muessen denselben
  Wortlaut fuer:
  - `single`
  - `pre-post`
  - Split-ohne-Output
...
- `spec/cli-spec.md` um `--split single|pre-post` erweitern
...
- die Exit-2-Meldungen sind ueber die in 5.3 definierten Contracttexte
  stabil und testbar
- `spec/cli-spec.md`, Help-Text und Runner-Verhalten sprechen denselben
  Vertrag
...
- Nutzer sehen in Help, Tests und `spec/cli-spec.md` leicht

...
> Referenzen: `docs/ddl-generation-rules.md`,
> `docs/design-import-sequences-triggers.md`,
> `docs/cli-spec.md`,
> `docs/roadmap.md`
...
- `docs/ddl-generation-rules.md` um Split-Vertrag erweitern
- `docs/cli-spec.md` um `--split` erweitern

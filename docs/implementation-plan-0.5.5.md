...
>
> Status: Draft
> Referenzen: `docs/roadmap.md` Milestone 0.5.5, `docs/change-request-spatial-types.md`,
> `docs/neutral-model-spec.md`, `docs/ddl-generation-rules.md`,
> `docs/cli-spec.md` Abschnitt `schema generate`, `docs/architecture.md`.
...
- `docs/neutral-model-spec.md` und `docs/ddl-generation-rules.md` dokumentieren
...
- Der Change Request `docs/change-request-spatial-types.md` ist bereits als
...
- Negativtests fuer ungueltige `geometry_type`-/`srid`-Faelle und
  Profil-Mismatches
- Aktualisierung von `docs/neutral-model-spec.md`,
  `docs/ddl-generation-rules.md`, `docs/cli-spec.md` und `docs/architecture.md`
...
1. `docs/neutral-model-spec.md` um `geometry`, `geometry_type`, `srid` und
   Spatial-Profil-Hinweise erweitern.
2. `docs/ddl-generation-rules.md` fuer Spatial-DDL, `action_required` und
   `W120` konkretisieren.
3. `docs/cli-spec.md` fuer `schema generate` um `--spatial-profile` erweitern.
4. `docs/architecture.md` um den neuen Generator-Options-Pfad und die
   Typsystem-Erweiterung ergaenzen.
5. `docs/change-request-spatial-types.md` nur noch als CR-Entscheidungsbasis
...
- [ ] Golden Masters fuer Spatial-DDL existieren fuer PostgreSQL, MySQL und
      SQLite.
- [ ] `docs/neutral-model-spec.md`, `docs/ddl-generation-rules.md`,
      `docs/cli-spec.md` und `docs/architecture.md` sind auf demselben Stand.

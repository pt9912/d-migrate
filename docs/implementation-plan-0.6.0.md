...
>
> Status: Draft
> Referenzen: `docs/roadmap.md` Milestone 0.6.0,
> `docs/connection-config-spec.md`, `docs/cli-spec.md` Abschnitt
> `schema reverse` / `schema compare`, `docs/neutral-model-spec.md`,
...
- `schema reverse` ist in `docs/cli-spec.md` und
  `docs/neutral-model-spec.md` bereits als zukuenftiges Kommando beschrieben,
...
1. `docs/cli-spec.md` fuer `schema reverse` auf den 0.6.0-Live-DB-Vertrag
   ziehen:
...
3. `docs/cli-spec.md` fuer `schema compare` von file-only auf
   `file/db`- und `db/db`-Vergleich erweitern.
4. `docs/neutral-model-spec.md` fuer die reverse-relevanten Metadatenluecken
   abgleichen.
5. `docs/architecture.md` auf die reale Port-Einfuehrung ueber

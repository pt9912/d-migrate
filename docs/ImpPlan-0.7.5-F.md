...
> `docs/ImpPlan-0.7.5-D.md`; `docs/ImpPlan-0.7.5-E.md`;
> `docs/roadmap.md` Milestone 0.7.5; `docs/profiling.md`;
> `docs/design.md` Abschnitt 3.6; `docs/cli-spec.md`; `docs/architecture.md`;
> `docs/guide.md`
...
- `docs/cli-spec.md`, `docs/design.md`, `docs/architecture.md` und bei Bedarf
  `docs/guide.md` beschreiben nur den real gelieferten 0.7.5-Scope
- spaetere Zielbilder aus `docs/profiling.md` werden nicht rueckwirkend so
...
Vollbild aus `docs/profiling.md`.
...
- `docs/cli-spec.md` enthaelt den finalen `data profile`-Vertrag
- `docs/design.md` beschreibt Profiling 3.6 im real gelieferten Stand
- `docs/architecture.md` spiegelt Modul- und Adapterstruktur korrekt
- `docs/guide.md` wird nur aktualisiert, wenn sie fuer Nutzer einen echten
...
- `docs/guide.md`, falls eine kurze Nutzerfuehrung fuer `data profile` echten
  Mehrwert bringt

...
- `docs/cli-spec.md` dokumentiert `schema generate` aktuell ohne
  `--spatial-profile` und ohne dialektspezifische Default-Profile.
- `docs/architecture.md` beschreibt `DdlGenerator` und
...
Nach Phase A muessen `docs/neutral-model-spec.md`,
`docs/ddl-generation-rules.md`, `docs/cli-spec.md` und
`docs/architecture.md` gemeinsam den produktiven 0.5.5-Vertrag tragen.
...
### A.1 `docs/neutral-model-spec.md`
...
### A.2 `docs/ddl-generation-rules.md`
...
### A.5 `docs/change-request-spatial-types.md`
...
- `docs/change-request-spatial-types.md`

Indirekt betroffen als Referenz- und Abnahmebasis:

- `docs/implementation-plan-0.5.5.md`
- `docs/roadmap.md`
...
- [ ] `docs/neutral-model-spec.md` beschreibt `geometry`,
      `geometry_type` und `srid` explizit und konsistent mit dem freigegebenen
      CR-Phase-1-Scope.
- [ ] `docs/ddl-generation-rules.md` dokumentiert Spatial-Regeln fuer
      PostgreSQL/PostGIS, MySQL und SQLite/SpatiaLite inklusive `E052` und
      `W120`.
- [ ] `docs/cli-spec.md` beschreibt `--spatial-profile`, die zulaessigen Werte
      je Dialekt und die dokumentierten Defaults.
- [ ] `docs/architecture.md` beschreibt den neuen Generator-Options-Pfad
...
- [ ] `docs/change-request-spatial-types.md` ist als Entscheidungsbasis
...
2. Abgleich gegen `docs/change-request-spatial-types.md`, damit die regulaeren
...
- Vergleich der `schema generate`-Beschreibung in `docs/cli-spec.md` mit den
  Regeln in `docs/ddl-generation-rules.md`

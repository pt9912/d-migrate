...
> Referenzen: `docs/roadmap.md` Milestone 0.7.5, `docs/profiling.md`,
> `docs/design.md` Abschnitt 3.6 Daten-Profiling, `docs/architecture.md`,
> `docs/lastenheft-d-migrate.md` LF-004, bestehende Datenpfade
...
- `docs/cli-spec.md` enthaelt noch keinen produktiven Vertrag fuer
  `data profile`.
...
- `docs/profiling.md` beschreibt bereits ein groesseres Zielbild, inklusive
...
Das ist die belastbare Initial-Scheibe. `docs/profiling.md` beschreibt ein
...
- `docs/profiling.md` bleibt das groessere Design-Zielbild; der produktive
  0.7.5-Vertrag wird spaeter in `docs/cli-spec.md` und `docs/design.md`
...
- `docs/cli-spec.md`-Luecke fuer `data profile` im Plan dokumentieren
...
- `docs/profiling.md` beschreibt heute einen groesseren Zielraum. Vor oder mit
...
### R5 - `docs/profiling.md` ist groesser als der Roadmap-Kern
...
- [ ] Nicht gelieferte Endbild-Teile aus `docs/profiling.md` sind nicht

...
- **Erstarbeit** fuer Artefakte, die in keinem frueheren WP zugesagt
  ...
  `docs/guide.md` Beispiel-Update, `docs/roadmap.md` Scope-Verweis
...
- `docs/guide.md` um `default: { sequence_nextval: ... }` Beispiel
  erweitern
- `docs/roadmap.md` mit Verweis auf den erreichten 0.9.3-Scope
- `docs/mysql-sequence-emulation-plan.md` auf den tatsaechlichen
...
- `docs/neutral-model-spec.md` und `docs/schema-reference.md`
  dokumentieren nur die Objektform
- `docs/guide.md` zeigt die Objektform in mindestens einem Beispiel
...
- eine separate Migrationssektion (im CHANGELOG oder als eigener
  Abschnitt in `docs/guide.md`) enthaelt:
...
- `docs/cli-spec.md`
- `docs/guide.md`
- ggf. `docs/mysql-sequence-emulation-plan.md`
...
- `docs/neutral-model-spec.md`: `default.sequence_nextval` als
  kanonische Form dokumentiert?
- `docs/schema-reference.md`: nutzerorientierte Syntax korrekt?
- `docs/cli-spec.md`: `--mysql-named-sequences` Vertrag konsistent?
- `docs/ddl-generation-rules.md`: Warning-Codes, MySQL-Modus,
...
- `docs/neutral-model-spec.md` zeigt `default.sequence_nextval`
  als einzige Eingabeform
- `docs/guide.md` enthaelt ein `sequence_nextval`-Beispiel
...
- `docs/guide.md` — `sequence_nextval`-Beispiel
- `docs/roadmap.md` — 0.9.3-Scope-Verweis
- `docs/mysql-sequence-emulation-plan.md` — Umsetzungsstand

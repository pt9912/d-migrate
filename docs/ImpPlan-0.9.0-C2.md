...
> `docs/ImpPlan-0.9.0-C.md`, `docs/ImpPlan-0.9.0-C1.md`;
...
- der Marker ist ein **Composite** aus `--since-column`-Wert **und**
  ...
  `docs/cli-spec.md`) bleibt ein anderer, gröberer Kontrakt und wird
...
- Single-File-Fortsetzung mit **einer Tabelle**:
  - der Basispfad des Exports erlaubt Single-File bereits heute **nur**
    fuer genau eine Tabelle (`StreamingExporter` wirft sonst; `docs/cli-spec.md`

...
> `docs/design.md`; `docs/connection-config-spec.md`
...
- `docs/cli-spec.md` beschreibt `schema reverse` noch als
...
- die Kopfzeile von `docs/cli-spec.md` behauptet zudem noch, dass aktuell nur
  ...
  existieren.
- `docs/neutral-model-spec.md` enthaelt weiterhin einen parserzentrierten
  Reverse-Abschnitt mit SQL-Datei-Input, Dialekt-Erkennung und dem Beispiel
  `schema reverse --source schema.sql --source-dialect ...`.
- `docs/architecture.md` dokumentiert bereits ein `DatabaseDriver`-Interface mit
...
- `docs/design.md` beschreibt fuer Reverse weiterhin zwei gleichwertige Pfade
  (JDBC plus DDL-Parser) und vermischt damit spaetere Parser-Ideen mit dem
  0.6.0-Live-DB-Scope.
- `docs/connection-config-spec.md` ist dagegen bereits eine belastbare Basis fuer
...
- Abgleich von `docs/architecture.md` mit dem realen Driver-Iststand und der
  additiven Port-Einfuehrung fuer 0.6.0
- Bereinigung parserzentrierter Reverse-Aussagen in `docs/neutral-model-spec.md`
  und `docs/design.md`
...
`docs/cli-spec.md` soll fuer 0.6.0 keine zweite, leicht andere URL-Spezifikation
aufbauen.

Verbindliche Folge:

- URL-Syntax, Dialekt-Aliase und Named-Connection-Aufloesung bleiben in
  `docs/connection-config-spec.md` kanonisch
- `docs/cli-spec.md` referenziert diese Regeln und beschreibt nur die
...
### A.2 `docs/neutral-model-spec.md`
...
- `docs/design.md` stuetzt den 0.6.0-Masterplan, statt aeltere
  Produktvorstellungen parallel weiterzutragen

### A.5 `docs/connection-config-spec.md`
...
- `docs/implementation-plan-0.6.0.md`
- `docs/roadmap.md`
...
1. Querlesen von `docs/cli-spec.md`, `docs/neutral-model-spec.md`,
   `docs/architecture.md`, `docs/design.md` und
   `docs/connection-config-spec.md` auf konsistente 0.6.0-Aussagen.

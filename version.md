...
<a id="aktuell"></a>
Aktuelle Version: [`v1.4.0`](#v1.4.0) — 2026-09-13 (Stable).

<a id="docker-tag"></a>
Aktuelles Docker-Image-Tag: `1.4.0` — Docker-Tags tragen anders als der
Git-Tag/GitHub-Release kein führendes `v` (`ghcr.io/pt9912/d-migrate:1.4.0`,
nicht `:v1.4.0`).
...
| ------- | ----- | --- | ------- |
| `v1.4.0` <a id="v1.4.0"></a> | 2026-09-13 | Stable | [Tag v1.4.0](https://github.com/pt9912/d-migrate/releases/tag/v1.4.0) |

...
/**
 * LF-017 / LF-024 / LN-030 / LN-031 — Wiring-Bundle für die KI-nahen
 * MCP-Tools.
 *
 ...
 *
 * Strikte Default-Vorgaben (LF-017 / LF-024 / LN-030 / LN-031): ohne explizite
 ...
 *   Lease/Reclaim (LF-017 / LF-024 / LN-030 / LN-031). Default = [InProcessAiToolOutcomeStore].
 * @param aiArtifactMetadataStore Provenance-Store für KI-Artefakte
 *   (LF-017 / LF-024 / LN-030 / LN-031). Default = [InProcessAiArtifactMetadataStore].
 * @param aiProviderRegistry Provider-Registry mit
 *   fail-closed-Konfiguration (LF-017 / LF-024 / LN-030 / LN-031). Default =
 ...
 *   (LF-017 / LF-024 / LN-030 / LN-031). Default = [DefaultPromptHygieneService].

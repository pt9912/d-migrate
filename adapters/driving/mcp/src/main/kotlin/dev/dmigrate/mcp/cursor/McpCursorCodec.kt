...
/**
 * LF-012 / LN-038 §10.3: opaque, HMAC-sealed cursor for the public MCP
...
/**
 * Cursor payload LF-012 / LN-038 pins per §10.3. Pure data; no behaviour.
 *
...
/**
 * LF-012 / LN-038 §10.3 keyring: exactly one active signing key + zero or

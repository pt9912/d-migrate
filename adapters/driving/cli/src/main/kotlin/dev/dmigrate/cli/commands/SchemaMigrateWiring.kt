...
internal object SchemaMigrateWiring {
    ...
    internal fun executeInternal(
        ...
        val request = SchemaMigrateRequest(
            ...
            provenanceOutput = options.provenanceOutput,
        ...
        val runner = SchemaMigrateRunner(
            ...
            targetAwareComparator = { left, right, projection ->
                SchemaComparator(projection).compare(left, right)
            },

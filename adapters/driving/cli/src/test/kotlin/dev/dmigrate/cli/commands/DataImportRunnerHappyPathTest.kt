...
class DataImportRunnerHappyPathTest : FunSpec({
    ...
    val tempDir: Path = Files.createTempDirectory("dmigrate-import-dir-").also {
        Files.writeString(it.resolve("users.json"), """[{"id":1}]""")
    }

...
class CliGenerateTest : FunSpec({
    ...
    test("E2E: DDL header contains d-migrate 0.9.3 version") {
        val source = writeTempSchema(minimalSchemaYaml)
        try {
            ...
            out shouldContain "Generated by d-migrate 0.9.3"
        } finally {
            Files.deleteIfExists(source)
        }
    }

    test("E2E: Report contains d-migrate 0.9.3 generator string") {
        val source = writeTempSchema(minimalSchemaYaml)

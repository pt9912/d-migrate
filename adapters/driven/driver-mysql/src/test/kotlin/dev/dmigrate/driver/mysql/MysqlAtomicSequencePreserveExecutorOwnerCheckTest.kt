...
/**
 * Atomic-Preserve Phase C.3 owner-vertrag pin for the MySQL
 * executor. Mirror of the PG and SQLite pins; see
 * `AtomicSequencePreserveContractTest` for the shared helper's
 * unit coverage. Empty batches short-circuit before the check.
 */
class MysqlAtomicSequencePreserveExecutorOwnerCheckTest : FunSpec({

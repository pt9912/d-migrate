...
SILENT_LOSS_KNOWN=(
    ...
    "ziel postgresql->mysql: sl_pg_array.tags: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->sqlite: sl_pg_array.tags: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->mysql: sl_pg_array.counts: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->sqlite: sl_pg_array.counts: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->mysql: sl_pg_array.totals: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->sqlite: sl_pg_array.totals: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->mysql: sl_pg_array.due_dates: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->sqlite: sl_pg_array.due_dates: Degradierung ohne W162 im Generate-Report|P5 (Plan 2)"
    "ziel postgresql->mysql: sl_pg_identity_big.id: Degradierung ohne W163 im Generate-Report|P10 (Plan 2)"

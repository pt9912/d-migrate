...
sealed interface ProgressEvent {
    ...
    data class RunStarted(
        ...
        val totalTables: Int,
        /**
         * LF-013 / LN-012 / LN-017: stabile `operationId` fuer den
         * gesamten Lauf. Wird in
         * [ExportResult.operationId]/[ImportResult.operationId]
         * gespiegelt und darf in den stderr-nahen Progress-/Summary-
         * Pfaden nicht verloren gehen. Legacy-Callsites, die noch
         * keine operationId haben, duerfen temporaer `null` uebergeben.
         */
        val operationId: String? = null,
        /**
         * LF-013 / LN-012: `true`, wenn der Lauf eine Wiederaufnahme

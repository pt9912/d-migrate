...
fun Arb.Companion.neutralType(): Arb<NeutralType> {
    ...
    val enum: Arb<NeutralType> = Arb.bind(
        ...
        //
        // Werte/refType sind bewusst UNbeschränkte Strings: number-/bool-/null-/
        // timestamp-artige Enum-Labels (`4.`, `9_`, `yes`, `~`) sind legale
        // Schemata, und der YAML-Codec round-trippt sie seit dem
        // `YamlImplicitAwareQuotingChecker` (LN-046) verlustfrei. Dieses PBT ist
        // die Abnahme dafür — daher hier KEINE YAML-sichere Einschränkung.

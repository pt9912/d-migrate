...
/**
 * Phase E §7.7 `schema_reverse_start`-Worker.
 *
 * Verkettet die drei Plan-§7.7-Schritte fuer einen Reverse-Job:
 *
 ...
 *    (Phase A) und reichen den Token an alle Statement-Grenzen
 *    durch.
 ...
 *
 * Cancel-Verhalten (Plan §7.7 + E0-Checkpoints):
 *
 ...
 *
 * Per Plan §7.7 ist dieser Worker pro Job konstruiert ([connectionRef]

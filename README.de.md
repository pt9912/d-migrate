...
- **Spatial-DDL auf allen fünf Dialekten**: PostGIS unter PostgreSQL,
  native räumliche Typen unter MySQL, SQL Server und Oracle, SpatiaLite
  unter SQLite (`--spatial-profile`); View-Query-Transformation über
  Dialekte hinweg.
